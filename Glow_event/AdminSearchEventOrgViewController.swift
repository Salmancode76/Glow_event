...
class AdminSearchEventOrgViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    @IBAction func openFilterPage(_ sender: UIButton) {
        ...
        if let filterVC = storyboard?.instantiateViewController(withIdentifier: "AdminFilterPageOrg") as? AdminFilterTableViewController {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)  {
        ...
        if let vc = storyboard?.instantiateViewController(identifier: "AdminEventDetailOrg") as? AdminEventDetailOrgViewController {
   ...
   extension AdminSearchEventOrgViewController: AdminFilterTableViewControllerDelegate {
