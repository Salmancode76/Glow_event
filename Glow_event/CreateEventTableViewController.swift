...
class CreateEventTableViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func stepUI(){
        ...
        //setting colors
        CreateEventTable.backgroundColor = UIColor.black
    ...
    @IBAction func CreateEvent(_ sender: Any) {
        ...
        guard startDateValue <= endDateValue else {
            showErrorAlert(message: "Start date can't be after end date")
            return
        }
        ...
        CloudinarySetup.uploadeEventImage(image: eventImage) { [weak self] uploadedUrl in
            ...
            if let url = uploadedUrl {
                ...
                //Using Firebase to store the date
    ...
    //Methods to communicate with the user
