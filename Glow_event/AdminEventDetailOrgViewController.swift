import Foundation
import UIKit
class AdminEventDetailOrgViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
   ...
   // var event: Event?
    ...
    @IBAction func EditEvnt(_ sender: Any) {
        if let vc = storyboard?.instantiateViewController(identifier: "AdminEditEventOrg") as? AdminEditEventTableViewController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "EventDetailOrgTableViewCell", for: indexPath) as! AdminEventDetailOrgTableViewCell
